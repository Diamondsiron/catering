...
import appointment from '@/views/test/appointment.vue'
import index from '@/views/index/index.vue'
import indent from '@/views/test/indent.vue'
...
import charge from '@/views/test/charge.vue'
import coupon from '@/views/test/coupon.vue'
...
import integral from '@/views/test/integral.vue'
import Invitation from '@/views/test/Invitation.vue'
...
import remaining from '@/views/test/remaining.vue'
